...
const journey: RouteStop[] = [
  {
    ...
    organization: 'CENTRE FOR DATA FOR PUBLIC GOOD (CDPG), IISc BENGALURU',
    description:
      'Building Angular frontends and Node.js/Express.js backends, designing REST API flows through routes, middleware and controllers, and integrating MySQL with mysql2.',
  },
  {
    id: '02',
    year: '2026',
    ...
    organization:
      'HACKFEST 2.0 • GENERATIVE AI MASTERMIND • VIBE HACK 2.0 • BUILD WITH TRAE • APTICODE ARENA 2026',
    description:
      'Participated in multiple hackathons and technical programs including HackFest 2.0 by GDG Cloud New Delhi × Turgon AI, Generative AI Mastermind by Outskill, Vibe Hack 2.0, Build with TRAE, and AptiCode Arena 2026. Vibe Hack 2.0 reached the Top 5,000 of 25,000 teams with a Google Office finale.',
  },
  {
    id: '03',
    year: '2023 - 2027',
    ...
    organization: 'AKTU',
    description:
      'Pursuing B.Tech in Computer Science & Engineering at AKTU with a current CGPA of 7.2 through the 5th semester.',
  },
  {
    id: '04',
    year: '2022 - 2023',
    ...
    description: 'Completed Class 12 under the CBSE board with 67%.',
  },
  {
    id: '05',
    year: '2020 - 2021',
    title: '10TH — HARYANA BOARD',
    organization: 'HARYANA BOARD OF SCHOOL EDUCATION',
    description: 'Completed Class 10 under the Haryana Board with 86%.',
  },
];
