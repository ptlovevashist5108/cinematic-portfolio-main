      ...
      <div className="relative z-10 flex flex-col justify-between min-h-screen w-full px-6 sm:px-12 lg:px-16 pt-6 pb-8 pointer-events-none">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          >
            ...
            >
              <p>
                I&apos;m Love Sharma, a B.Tech CSE student at AKTU (2023–2027)
                with hands-on full-stack development experience.
                <br />
                Currently a Full Stack Developer Intern at CDPG, IISc Bengaluru,
                building Angular frontends and Node.js/Express.js backends,
                designing REST API flows, and integrating MySQL with mysql2.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.a
                href="/resume.pdf"
                download="Love-Sharma-Resume.pdf"
                onMouseEnter={() => setIsHovered(true)}
                onMouseLeave={() => setIsHovered(false)}
                whileHover={{ scale: 1.02 }}
          ...
          >
            ...
            <div
              ...
              style={{ fontFamily: "'Herr Von Muellerhoff', 'Allura', cursive", letterSpacing: '0.04em' }}
            >
              Love Sharma
            </div>
          </motion.div>
