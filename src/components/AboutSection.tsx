...
export const AboutSection: React.FC = () => {
  ...
  const spotlightBg = useTransform(
    ...
    ([x, y]) =>
      'radial-gradient(circle 240px at ' +
      x +
      'px ' +
      y +
      'px, rgba(255,255,255,0.35), rgba(212,175,55,0.18), transparent 80%)'
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              , a B.Tech CSE student at AKTU (2023–2027) with hands-on
              full-stack development experience. Currently a Full Stack
              Developer Intern at the Centre for Data for Public Good (CDPG),
              IISc Bengaluru, building Angular frontends and
              Node.js/Express.js backends, designing REST API flows, and
              integrating MySQL with mysql2.
            </motion.p>
