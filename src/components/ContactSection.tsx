      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
            ...
            <div>
              ...
              <div className="mt-8 space-y-3">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  lovevashist3@gmail.com
                </p>

                <a
                  href="https://www.linkedin.com/in/love-sharma-0519b9307?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block text-xs text-[#A8988B] hover:text-[#D4AF37] transition-colors"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  linkedin.com/in/love-sharma
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] uppercase">
            LOVE SHARMA // PORTFOLIO // EDITION 2026
          </span>
