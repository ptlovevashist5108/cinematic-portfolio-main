...
const bentoCategories = [
  {
    ...
    description: 'Working across Python, JavaScript, TypeScript and C to build full-stack applications, backend services and problem-solving solutions.',
    stat: '4 LANGUAGES',
  ...
  },
  {
    ...
    badge: 'UI & CLIENT',
    items: ['Angular', 'HTML5', 'CSS3', 'React', 'Vite'],
    description: 'Building responsive frontend applications with Angular and React, using TypeScript, HTML5, CSS3 and Vite for modern client-side development.',
    stat: 'ANGULAR + REACT',
  ...
  },
  {
    title: 'BACKEND & APIS',
    badge: 'SERVER SIDE',
    items: ['Node.js', 'Express.js', 'Flask', 'REST APIs', 'JSON', 'HTTP/HttpClient'],
    description: 'Developing backend services with Node.js, Express.js and Flask, designing REST API flows and handling JSON-based client-server communication.',
    stat: 'REST API',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'DATA & SYSTEMS',
    items: ['MySQL', 'SQLite3', 'SQL', 'PostgreSQL', 'Git', 'VS Code', 'DSA', 'DBMS', 'OS', 'Computer Networks'],
    description: 'Working with relational databases and essential computer science concepts, alongside everyday development tools such as Git, VS Code and MySQL Workbench.',
    stat: 'FULL STACK',
    colSpan: 'lg:col-span-7',
  },
];
