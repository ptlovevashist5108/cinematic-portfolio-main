...
const projects: Project[] = [
  {
    number: '01',
    title: 'Smart City Weather Application',
    ...
    metrics: [
      { label: 'FRONTEND', value: 'Angular + HttpClient' },
      { label: 'BACKEND', value: 'Node.js + Express.js' },
      { label: 'DATABASE', value: 'MySQL + mysql2' },
    ],
  },
  {
    number: '02',
    title: 'Pharma Inventory & Billing Management System',
    ...
    metrics: [
      ...
      { label: 'BILLING', value: 'Automated GST Invoices' },
    ],
  },
  {
    number: '03',
    title: 'Todo List App — Full-Stack Task Manager',
    ...
    metrics: [
      { label: 'AUTHENTICATION', value: 'Keycloak' },
      { label: 'DATABASE', value: 'PostgreSQL' },
      { label: 'OPERATIONS', value: 'Complete CRUD' },
    ],
  },
  {
    number: '04',
    title: "Kavita's Slimming Point",
  ...
  },
  {
    ...
    metrics: [
      { label: 'APPLICATION', value: 'Desktop App' },
      { label: 'PROCESSING', value: 'Multithreaded' },
      { label: 'OUTPUT', value: 'QR + PDF Export' },
    ],
  },
  {
    number: '06',
    title: 'Expense Calculator / Tracker',
